...
<head>
    ...
    <title>Comenzi — {{ now()->format('d.m.Y') }}</title>
...
<div class="order-page">
    ...
    <div class="print-header">
        <div>
            ...
            <div class="print-brand-sub">Comandă magazin ({{ $loop->iteration }}/{{ $orders->count() }})</div>
        </div>
...
@empty
<p style="padding:24px;font-size:14px">Nu există comenzi pentru filtrele selectate.</p>
@endforelse
