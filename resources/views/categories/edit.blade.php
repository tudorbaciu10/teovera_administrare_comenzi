...
@section('title', __('admin.btn_editeaza').' — '.__('admin.categorii_titlu'))
@section('page-title', __('admin.categorii_titlu'))

@section('content')
<div class="card" style="max-width:500px">
    <div class="card-header">
        <span class="card-title">{{ __('admin.btn_editeaza') }}: {{ $category->nume_ro }}</span>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('categories.update', $category) }}">
            ...
            <div class="form-group {{ $errors->has('nume_ro') ? 'has-error' : '' }}">
                ...
                <input type="text" name="nume_ro" value="{{ old('nume_ro', $category->nume_ro) }}">
            ...
            <div class="form-group {{ $errors->has('nume_ru') ? 'has-error' : '' }}">
                ...
                <input type="text" name="nume_ru" value="{{ old('nume_ru', $category->nume_ru) }}">
            ...
            <div class="form-group {{ $errors->has('ordine_sortare') ? 'has-error' : '' }}">
                ...
                <input type="number" name="ordine_sortare" value="{{ old('ordine_sortare', $category->ordine_sortare) }}" min="0">
